...
def _extract_newspaper_uid(filename):
    ...
    logger.info('Extracting newspaper uid detected: {}'.format(newspaper_uid))
...
def _tokenize_column(df, column_name):
    logger.info('Calculating thhe number of unique tokens in {}'.format(column_name))
